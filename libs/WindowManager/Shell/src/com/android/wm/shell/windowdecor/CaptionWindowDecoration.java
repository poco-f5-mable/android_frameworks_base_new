...
public class CaptionWindowDecoration extends WindowDecoration<WindowDecorLinearLayout> {
    ...
    void createResizeVeil() {
        final BaseIconFactory resizeVeilIconFactory = createIconFactory(
            R.dimen.desktop_mode_resize_veil_icon_size);
        Bitmap resizeVeilBitmap = resizeVeilIconFactory
                .createScaledBitmap(mAppIcon, MODE_DEFAULT);
        mResizeVeil = new ResizeVeil(mContext, mDisplayController, resizeVeilBitmap,
    ...
    private BaseIconFactory createIconFactory(int dimensions) {
        ...
        return new BaseIconFactory(mContext, densityDpi, iconSize);
    }
}
